...
export default function Modal() {
  ...
  const selected_Images = selectedImages.map((image) => (
    <div
      key={image.name}
      className='mt-1 flex justify-center px-2 py-2 border-2 border-gray-300rounded-md'
    >
  ...
  return (
    <>
      <div className='flex items-center justify-center  text-center  container mx-auto mt-2'>
        <div className='relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle w-4/6 '>
                    ...
                    {isDragReject && (
                      <div className='text-red-500 text-center'>
                        <p className='text-sm font-medium'>
                          File type not supported. Please upload a jpeg, png,
                          gif, or jpg file.
                        </p>
                      </div>
                    )}
